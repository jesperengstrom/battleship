...
var ships = {
	Jolle: {name: "Jolle", size: 2, coords: [], float: true, mark: "j", color:"#4C1C00"},
	Sub: {name: "Sub", size: 2, coords: [], float: true, mark: "s", color:"#95B544"},
	Gunboat: {name: "Gunboat", size: 3, coords: [], float: true, mark: "g", color: "#D8B400"},
	Torpedoboat: {name: "Torpedoboat", size: 4, coords: [], float: true, mark:"t", color: "#DD8418"},
	Battleship: {name: "Battleship", size: 5, coords: [], float: true, mark: "b", color: "#CC4D2A"},
	Tanker: {name: "Tanker", size: 6, coords: [], float: true, mark: "T", color: "#700353"}
};
...
function createPlayingField() {
	...
	for (var j = 0; j < rows; j++) {
		...
		for (var i = 0; i < cols; i++) {
			playingField.push({row:j, col:i, id:id, ship:false, hit:false, mark:"-", color: "#5593D1"});
